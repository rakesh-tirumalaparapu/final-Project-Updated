      ...
      <div className="container-fluid">
        ...
        <div className="row mb-5">
          <div className="col-lg-4 col-md-6 mb-3">
            <div className="card card-custom quick-action-card" onClick={() => navigate('/customer-dashboard/loanapplication')}>
          ...
          <div className="col-lg-4 col-md-6 mb-3">
            <div className="card card-custom quick-action-card" onClick={() => navigate('/customer-dashboard/applications')}>
              <div className="card-body text-center">
          ...
          <div className="col-lg-4 col-md-6 mb-3">
            <div className="card card-custom quick-action-card" onClick={() => navigate('/customer-dashboard/profile')}>
              <div className="card-body text-center">
